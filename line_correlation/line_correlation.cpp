...
/*
 ...
 Compile as:
 mpicc line_correlation.cpp -I/../include -L/../local/lib -lfftw3 -DWITHMPI -O3 -o run_mpi
   icc line_correlation.cpp -I/../include -L/../local/lib -lfftw3 -O3 -o run_nompi

 Run as:
 ./run_nompi /path/to/folder/containing/output_xxxxx/ xxxxx numfiles npart boxsize nbins outputprefix
 mpirun -np x ./run_mpi /path/to/folder/containing/output_xxxxx/ xxxxx numfiles npart boxsize nbins outputprefix
...
double estimate_progress_monte_carlo(double x, double y, bool reset){
  ...
  // Calculate percentag n / n_expected * 100 
